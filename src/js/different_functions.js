$(function () {
    ...
    const shortWidth = function () {
        ...
        if ($(window).width() < 864) {
            $("header span").hide();
            $("nav ul li ul:eq(0) span").html("<img src='img/Main/billetGold.png'>");
            $("nav ul li ul:eq(1) span").html("<img src='img/Main/billetSilver.png'>");
            $("nav ul li ul:eq(2) span").html("<img src='img/Main/tips.png'>");
            $("nav ul li ul:eq(3) span").html("<img src='img/Main/contact.png'>");
            $("nav ul li ul").on("mouseover", function () {
